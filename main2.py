...
# cap = cv2.VideoCapture("C:/Users/dyl01/OneDrive/바탕 화면/2021.6.13  비디오2.mp4")
cap = cv2.VideoCapture("C:/Users/dyl01/OneDrive/바탕 화면/매우느리게.mp4")
...
def run():        
    ...
    # cap = cv2.VideoCapture("C:/Users/dyl01/OneDrive/바탕 화면/횡단보도 비디오6_Trim.mp4")
    cap = cv2.VideoCapture("C:/Users/dyl01/OneDrive/바탕 화면/매우느리게.mp4")
    crosswalk_pts = np.array([[166,275],[161,319],[129,355],[77,393],[-4,423],[900,436],[846,398],[820,345],[840,320]])
    ...
    # 
        ...
        # window position
            cv2.moveWindow("signal",1300,170)
            cv2.moveWindow("Frame",300,200)
            cv2.moveWindow("Mask",300,200)
            cv2.moveWindow("Button",1600,403)
        #  
